...
define inline C-function tickit-pen-new
  result res :: <TickitPen*>;
  c-name: "tickit_pen_new";
end;

define inline C-function tickit-pen-clone
  input parameter orig_ :: <TickitPen*>;
  result res :: <TickitPen*>;
  c-name: "tickit_pen_clone";
end;

define inline C-function tickit-pen-destroy
...
define inline C-function tickit-pen-is-nonempty
  input parameter pen_ :: <TickitPen*>;
  result res :: <C-boolean>;
  c-name: "tickit_pen_is_nonempty";
end;

define inline C-function tickit-pen-nondefault-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
  result res :: <C-boolean>;
...
define inline C-function tickit-pen-is-nondefault
  input parameter pen_ :: <TickitPen*>;
  result res :: <C-boolean>;
  c-name: "tickit_pen_is_nondefault";
end;

define inline C-function tickit-pen-get-bool-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
  result res :: <C-boolean>;
...
define inline C-function tickit-pen-set-bool-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
...
define inline C-function tickit-pen-get-int-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
...
define inline C-function tickit-pen-set-int-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
...
define inline C-function tickit-pen-get-colour-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
  result res :: <C-signed-int>;
...
define inline C-function tickit-pen-set-colour-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
...
define inline C-function tickit-pen-clear-attr
  input parameter pen_ :: <TickitPen*>;
  input parameter attr_ :: <TickitPenAttr>;
  c-name: "tickit_pen_clear_attr";
end;

define inline C-function tickit-pen-clear
  input parameter pen_ :: <TickitPen*>;
  c-name: "tickit_pen_clear";
end;

define inline C-function tickit-pen-equiv-attr
...
define inline C-function tickit-pen-equiv
  input parameter a_ :: <TickitPen*>;
  input parameter b_ :: <TickitPen*>;
  result res :: <C-boolean>;
...
define inline C-function tickit-pen-copy-attr
...
define inline C-function tickit-pen-copy
  input parameter dst_ :: <TickitPen*>;
  input parameter src_ :: <TickitPen*>;
...
define inline C-function tickit-pen-bind-event
...
define inline C-function tickit-pen-unbind-event-id
  input parameter tt_ :: <TickitPen*>;
  input parameter id_ :: <C-signed-int>;
  c-name: "tickit_pen_unbind_event_id";
end;

define inline C-function tickit-pen-attrtype
  input parameter attr_ :: <TickitPenAttr>;
...
define inline C-function tickit-rect-init-sized
...
define inline C-function tickit-rect-init-bounded
  input parameter rect_ :: <TickitRect*>;
  input parameter top_ :: <C-signed-int>;
  input parameter left_ :: <C-signed-int>;
...
define inline C-function tickit-rect-translate
  input parameter rect_ :: <TickitRect*>;
...
define inline C-function tickit-rect-intersect
...
define inline C-function tickit-rect-intersects
  input parameter a_ :: <TickitRect*>;
  input parameter b_ :: <TickitRect*>;
  result res :: <C-boolean>;
...
define inline C-function tickit-rect-contains
...
define inline C-function tickit-rect-add
...
define inline C-function tickit-rect-subtract
...
define inline C-function tickit-rectset-new
  result res :: <TickitRectSet*>;
  c-name: "tickit_rectset_new";
end;

define inline C-function tickit-rectset-destroy
  input parameter trs_ :: <TickitRectSet*>;
  c-name: "tickit_rectset_destroy";
end;

define inline C-function tickit-rectset-clear
  input parameter trs_ :: <TickitRectSet*>;
  c-name: "tickit_rectset_clear";
end;

define inline C-function tickit-rectset-rects
  input parameter trs_ :: <TickitRectSet*>;
  result res :: <C-size-t>;
...
define inline C-function tickit-rectset-get-rects
  input parameter trs_ :: <TickitRectSet*>;
...
define inline C-function tickit-rectset-add
  input parameter trs_ :: <TickitRectSet*>;
  input parameter rect_ :: <TickitRect*>;
  c-name: "tickit_rectset_add";
end;

define inline C-function tickit-rectset-subtract
  input parameter trs_ :: <TickitRectSet*>;
  input parameter rect_ :: <TickitRect*>;
...
define inline C-function tickit-rectset-contains
  input parameter trs_ :: <TickitRectSet*>;
  input parameter rect_ :: <TickitRect*>;
  result res :: <C-boolean>;
...
define inline C-function tickit-term-new
...
define inline C-function tickit-term-destroy
...
define inline C-function tickit-term-set-output-fd
  input parameter tt_ :: <TickitTerm*>;
  input parameter fd_ :: <C-signed-int>;
  c-name: "tickit_term_set_output_fd";
end;

define inline C-function tickit-term-get-output-fd
  input parameter tt_ :: <TickitTerm*>;
  result res :: <C-signed-int>;
...
define inline C-function tickit-term-set-output-func
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-set-output-buffer
  input parameter tt_ :: <TickitTerm*>;
  input parameter len_ :: <C-size-t>;
  c-name: "tickit_term_set_output_buffer";
end;

define inline C-function tickit-term-await-started
  input parameter tt_ :: <TickitTerm*>;
  input parameter msec_ :: <C-signed-long>;
  c-name: "tickit_term_await_started_msec";
end;

define inline C-function tickit-term-flush
  input parameter tt_ :: <TickitTerm*>;
  c-name: "tickit_term_flush";
end;

define inline C-function tickit-term-set-input-fd
  input parameter tt_ :: <TickitTerm*>;
  input parameter fd_ :: <C-signed-int>;
  c-name: "tickit_term_set_input_fd";
end;

define inline C-function tickit-term-get-input-fd
  input parameter tt_ :: <TickitTerm*>;
  result res :: <C-signed-int>;
  c-name: "tickit_term_get_input_fd";
end;

define inline C-function tickit-term-get-utf8
  input parameter tt_ :: <TickitTerm*>;
  result res :: <TickitMaybeBool>;
  c-name: "tickit_term_get_utf8";
end;

define inline C-function tickit-term-set-utf8
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-input-readable
  input parameter tt_ :: <TickitTerm*>;
  c-name: "tickit_term_input_readable";
end;

define inline C-function tickit-term-input-check-timeout
  input parameter tt_ :: <TickitTerm*>;
  result res :: <C-signed-int>;
  c-name: "tickit_term_input_check_timeout_msec";
end;

define inline C-function tickit-term-input-wait
  input parameter tt_ :: <TickitTerm*>;
  input parameter msec_ :: <C-signed-long>;
...
define inline C-function tickit-term-get-size
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-set-size
  input parameter tt_ :: <TickitTerm*>;
  input parameter lines_ :: <C-signed-int>;
  input parameter cols_ :: <C-signed-int>;
...
define inline C-function tickit-term-refresh-size
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-unbind-event-id
  input parameter tt_ :: <TickitTerm*>;
  input parameter id_ :: <C-signed-int>;
...
define inline C-function tickit-term-goto
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-move
  input parameter tt_ :: <TickitTerm*>;
  input parameter downward_ :: <C-signed-int>;
  input parameter rightward_ :: <C-signed-int>;
...
define inline C-function tickit-term-scrollrect
  input parameter tt_ :: <TickitTerm*>;
  input parameter rect_ :: <TickitRect>;
  input parameter downward_ :: <C-signed-int>;
  input parameter rightward_ :: <C-signed-int>;
...
define inline C-function tickit-term-chpen
  input parameter tt_ :: <TickitTerm*>;
  input parameter pen_ :: <TickitPen*>;
  c-name: "tickit_term_chpen";
end;

define inline C-function tickit-term-setpen
  input parameter tt_ :: <TickitTerm*>;
  input parameter pen_ :: <TickitPen*>;
  c-name: "tickit_term_setpen";
end;

define inline C-function tickit-term-clear
  input parameter tt_ :: <TickitTerm*>;
  c-name: "tickit_term_clear";
end;

define inline C-function tickit-term-erasech
  input parameter tt_ :: <TickitTerm*>;
...
define inline C-function tickit-term-setctl-int
  input parameter tt_ :: <TickitTerm*>;
  input parameter ctl_ :: <TickitTermCtl>;
  input parameter value_ :: <C-signed-int>;
  result res :: <C-boolean>;
...
define inline C-function tickit-string-seqlen
...
define inline C-function tickit-renderbuffer-new
  input parameter lines_ :: <C-signed-int>;
  input parameter cols_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-destroy
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_destroy";
end;

define inline C-function tickit-renderbuffer-get-size
  input parameter rb_ :: <TickitRenderBuffer*>;
  output parameter lines_ :: <int*>;
  output parameter cols_ :: <int*>;
...
define inline C-function tickit-renderbuffer-translate
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter downward_ :: <C-signed-int>;
  input parameter rightward_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-clip
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter rect_ :: <TickitRect*>;
  c-name: "tickit_renderbuffer_clip";
end;

define inline C-function tickit-renderbuffer-mask
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter mask_ :: <TickitRect*>;
  c-name: "tickit_renderbuffer_mask";
end;

define inline C-function tickit-renderbuffer-has-cursorpos
  input parameter rb_ :: <TickitRenderBuffer*>;
  result res :: <C-boolean>;
...
define inline C-function tickit-renderbuffer-goto
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-ungoto
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_ungoto";
end;

define inline C-function tickit-renderbuffer-setpen
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter pen_ :: <TickitPen*>;
  c-name: "tickit_renderbuffer_setpen";
end;

define inline C-function tickit-renderbuffer-reset
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_reset";
end;

define inline C-function tickit-renderbuffer-save
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_save";
end;

define inline C-function tickit-renderbuffer-savepen
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_savepen";
end;

define inline C-function tickit-renderbuffer-restore
  input parameter rb_ :: <TickitRenderBuffer*>;
  c-name: "tickit_renderbuffer_restore";
end;

define inline C-function tickit-renderbuffer-skip-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  input parameter cols_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-skip
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter cols_ :: <C-signed-int>;
  c-name: "tickit_renderbuffer_skip";
end;

define inline C-function tickit-renderbuffer-skip-to
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter col_ :: <C-signed-int>;
  c-name: "tickit_renderbuffer_skip_to";
end;

define inline C-function tickit-renderbuffer-text-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-textn-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  input parameter text_ :: <c-string>;
...
define inline C-function tickit-renderbuffer-erase-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  input parameter cols_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-char-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  input parameter codepoint_ :: <C-signed-long>;
...
define inline C-function tickit-renderbuffer-hline-at
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-vline-at
  input parameter rb_ :: <TickitRenderBuffer*>;
...
define inline C-function tickit-renderbuffer-flush-to-term
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter tt_ :: <TickitTerm*>;
  c-name: "tickit_renderbuffer_flush_to_term";
end;

define inline C-function tickit-renderbuffer-blit
...
define inline C-function tickit-renderbuffer-get-cell-active
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  result res :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-get-cell-text
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
...
define inline C-function tickit-renderbuffer-get-cell-pen
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter col_ :: <C-signed-int>;
  result res :: <TickitPen*>;
...
define inline C-function tickit-renderbuffer-get-span
  input parameter rb_ :: <TickitRenderBuffer*>;
  input parameter line_ :: <C-signed-int>;
  input parameter startcol_ :: <C-signed-int>;
...
define inline C-function tickit-window-root
  input parameter win_ :: <TickitWindow*>;
  result res :: <TickitWindow*>;
  c-name: "tickit_window_root";
end;

define inline C-function tickit-window-destroy
  input parameter win_ :: <TickitWindow*>;
...
define inline C-function tickit-window-unbind-event-id
  input parameter win_ :: <TickitWindow*>;
  input parameter id_ :: <C-signed-int>;
  c-name: "tickit_window_unbind_event_id";
end;

define inline C-function tickit-window-raise
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_raise";
end;

define inline C-function tickit-window-raise-to-front
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_raise_to_front";
end;

define inline C-function tickit-window-lower
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_lower";
end;

define inline C-function tickit-window-lower-to-back
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_lower_to_back";
end;

define inline C-function tickit-window-show
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_show";
end;

define inline C-function tickit-window-hide
  input parameter win_ :: <TickitWindow*>;
  c-name: "tickit_window_hide";
end;

define inline C-function tickit-window-is-visible
  input parameter win_ :: <TickitWindow*>;
  result res :: <C-boolean>;
...
define inline C-function tickit-window-right
  input parameter win_ :: <TickitWindow*>;
  result res :: <C-signed-int>;
  c-name: "tickit_window_right";
end;

define inline C-function tickit-window-resize
  input parameter win_ :: <TickitWindow*>;
  input parameter lines_ :: <C-signed-int>;
  input parameter cols_ :: <C-signed-int>;
...
define inline C-function tickit-window-reposition
  input parameter win_ :: <TickitWindow*>;
  input parameter top_ :: <C-signed-int>;
  input parameter left_ :: <C-signed-int>;
...
define inline C-function tickit-window-get-pen
  input parameter win_ :: <TickitWindow*>;
  result res :: <TickitPen*>;
  c-name: "tickit_window_get_pen";
end;

define inline C-function %tickit-window-set-pen
  input parameter win_ :: <TickitWindow*>;
  input parameter pen_ :: <TickitPen*>;
  c-name: "tickit_window_set_pen";
end;

define inline C-function tickit-window-expose
  input parameter win_ :: <TickitWindow*>;
...
define inline C-function tickit-window-is-focused
  input parameter win_ :: <TickitWindow*>;
  result res :: <C-boolean>;
  c-name: "tickit_window_is_focused";
end;

define inline C-function tickit-window-set-focus-child-notify
  input parameter win_ :: <TickitWindow*>;
